...
public class ForgetJFrame extends JFrame implements MouseListener {
    ...
    public ForgetJFrame() throws IOException {
        readuserinformation();
        initJFrame();
        initview();
    ...
    public void initview(){
        ...
        //密码输入框
        passwordtext.setBounds(195, 194, 200, 30);
        ...
        //再次输入密码输入框
        repasswordtext.setBounds(195, 229, 200, 30);
        ...
        background.setBounds(0, -20, 470, 472);
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource()==rightCode){
            ...
            String repasswordinput=repasswordtext.getText();
            ...
            if (usernameinput.isEmpty()||passwordinput.isEmpty()||repasswordinput.isEmpty()){
            ...
            else if (!checkuser(usernameinput)) {
                ...
                if(!(passwordinput.matches("[a-zA-Z0-9]{4,16}"))){
                    System.out.println("密码不符合规则,请输入4-16位字母或数字");
                    showJDialog("密码不符合规则,请输入4-16位字母或数字");
                }
                    ...
                    try {
                        writenewpassword(usernameinput,passwordinput);
    ...
    public void mousePressed(MouseEvent e) {
        if(e.getSource()==login){
            ...
            register.setIcon(new ImageIcon("images/register/注册按下.png"));
        }
    }
    ...
    public boolean checkuser(String usernameinput){
        for (int i = 0; i < users.size(); i++) {
            user user1=users.get(i);
            if(user1.getName().equals(usernameinput)){
                return true;
            }
        }
        return false;
    ...
    public void writenewpassword(String usernameinput,String passwordinput) throws IOException {
